  ...
  <div class="row">
    <article class="col-md-8">
      ...
      <s:if test="#session.existUser != null">
        <!-- Sponser -->
        <s:if test="model.projectStatus == 'funding'"><div class="comments1">
          <div class="well">
            <h4>Sponser this item</h4>
            <form action="${pageContext.request.contextPath}/sponser_sponseProject?pid=<s:property value="model.pid"/>" method="post">
        ...
        <div class="media">
          ...
          <div class="media-body">
            <h4 class="media-heading"><a href="<s:url action="user_userPage">
              ...
              <small><s:property value="#c.timestamp"/></small>On
